...
int main(int argc, char *argv[]) {
    ...
    for (int i = 0; i < 1000000; i++) {
        ...
        if (x % 2 == 0) {
            ...
            if (table.getPCB(idx)->getState() !=
                ...
                //If PCB is already READY, skip to avoid duplicates 
                int priority = rand() % 50 + 1;  
    ...
    //Measure total execution time of 1 million operations
    ...
    q2.displayAll();
    //Display final ReadyQueue satte after operations
}
